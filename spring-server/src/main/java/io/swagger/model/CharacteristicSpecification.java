...
import io.swagger.model.CharacteristicSpecificationRelationship;
...
public class CharacteristicSpecification   {
  ...
  @Valid
  @OneToMany(targetEntity = CharacteristicSpecificationRelationship.class, cascade = CascadeType.ALL)
