...
import io.swagger.model.ServiceCandidateChangeEventPayload;
...
public class ServiceCandidateChangeEvent   {
  @JsonProperty("event")
  private ServiceCandidateChangeEventPayload event = null;
  ...
  public ServiceCandidateChangeEvent event(ServiceCandidateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  **/
  ...
  public ServiceCandidateChangeEventPayload getEvent() {
    return event;
  }

  public void setEvent(ServiceCandidateChangeEventPayload event) {
    this.event = event;
  }

  public ServiceCandidateChangeEvent eventId(String eventId) {
  ...
  **/
  ...
  public ServiceCandidateChangeEvent eventTime(OffsetDateTime eventTime) {
  ...
  **/
  ...
  public ServiceCandidateChangeEvent eventType(String eventType) {
  ...
  **/
  ...
  public ServiceCandidateChangeEvent correlationId(String correlationId) {
  ...
  **/
  ...
  public ServiceCandidateChangeEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public ServiceCandidateChangeEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  **/
  ...
  public ServiceCandidateChangeEvent description(String description) {
  ...
  **/
  ...
  public ServiceCandidateChangeEvent priority(String priority) {
  ...
  **/
  ...
  public ServiceCandidateChangeEvent timeOcurred(OffsetDateTime timeOcurred) {
