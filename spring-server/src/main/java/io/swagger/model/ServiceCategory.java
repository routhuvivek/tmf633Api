...
public class ServiceCategory   {
  ...
  @Valid
  @OneToMany(targetEntity = ServiceCandidateRef.class,cascade = CascadeType.ALL)
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, href, description, isRoot, lastUpdate, lifecycleStatus, name, parentId, version, category, serviceCandidate, validFor, baseType, schemaLocation, type);
  }
