...
import io.swagger.model.ServiceSpecificationCreateEventPayload;
...
public class ServiceSpecificationCreateEvent   {
  @JsonProperty("event")
  private ServiceSpecificationCreateEventPayload event = null;
  ...
  public ServiceSpecificationCreateEvent event(ServiceSpecificationCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  **/
  ...
  public ServiceSpecificationCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(ServiceSpecificationCreateEventPayload event) {
    this.event = event;
  }

  public ServiceSpecificationCreateEvent eventId(String eventId) {
  ...
  **/
  ...
  public ServiceSpecificationCreateEvent eventTime(OffsetDateTime eventTime) {
  ...
  **/
  ...
  public ServiceSpecificationCreateEvent eventType(String eventType) {
  ...
  **/
  ...
  public ServiceSpecificationCreateEvent correlationId(String correlationId) {
  ...
  **/
  ...
  public ServiceSpecificationCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public ServiceSpecificationCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  **/
  ...
  public ServiceSpecificationCreateEvent description(String description) {
  ...
  **/
  ...
  public ServiceSpecificationCreateEvent priority(String priority) {
  ...
  **/
  ...
  public ServiceSpecificationCreateEvent timeOcurred(OffsetDateTime timeOcurred) {
